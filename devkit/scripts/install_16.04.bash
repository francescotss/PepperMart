...
# Catkin workspace fot this project
ROS_CATKIN_SRC=`pwd`/../catkin_ws/src
...
sudo apt-get update
sudo apt-get install cmake g++ xterm libboost-dev libxml2 libxml2-dev libxml++2.6-dev flex

# Install ROS addons
sudo apt-get install ros-kinetic-joystick-drivers ros-kinetic-navigation ros-kinetic-stage-ros
